...
/**
 * Icone custom del progetto (fuori dal set lucide).
 * Icon from Material Symbols by Google — Apache License 2.0
 * @link https://github.com/google/material-design-icons/blob/master/LICENSE
 * @link https://icones.js.org/collection/all?s=earthquake&icon=material-symbols:earthquake
 */
export function Earthquake(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
