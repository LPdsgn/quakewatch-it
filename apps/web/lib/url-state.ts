 ...
 * Valori non validi o assenti usano i default: window='24h', area='italia', event=null, t=null.
 * L'area deve esistere in findAreaPreset; l'event e il t devono essere numerici (^\d+$).
 */
 ...
 * Ordine stabile: window, area, event, t.
 */
