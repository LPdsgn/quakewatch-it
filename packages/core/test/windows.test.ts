...
describe('toFdsnTime', () => {
  it('formatta ISO UTC senza millisecondi né Z (formato FDSN)', () => {
    expect(toFdsnTime(new Date('2026-08-01T10:23:45.678Z'))).toBe(
      '2026-08-01T10:23:45'
    )
  })
})
...
describe('normalizeUtcTime', () => {
  ...
  it('tronca i microsecondi a millisecondi', () => {
    expect(normalizeUtcTime('2026-08-01T10:23:45.123456')).toBe(
      '2026-08-01T10:23:45.123Z'
    )
  })
  it('non duplica la Z se già presente', () => {
    expect(normalizeUtcTime('2026-08-01T10:23:45Z')).toBe(
      '2026-08-01T10:23:45Z'
    )
  })
})
